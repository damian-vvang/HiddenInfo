...
namespace HiddenInfo
{
	public partial class Main : Form
	{
		...
		private void fileOpen1_button_Click(object sender, EventArgs e)
		{
			...
			{
				filePath1.Text = "No image selected for decryption!";
				fileName1.Text = null;
				details.Text = null;
				txtContentLoad.Text = null;
			}
		...
		private void fileOpen2_button_Click(object sender, EventArgs e)
		{
			...
			if (ofd.ShowDialog() == DialogResult.Cancel)
			{
				filePath2.Text = "No image selected for encryption!";
				txtContentWrite.Text = null;
				fileName2.Text = null;
				textName2.Text = null;
				textPath2.Text = null;
		...
		private void selectTxtFile_Click(object sender, EventArgs e)
		{
			...
			{
				textPath2.Text = "No text selected for encryption!";
				textName2.Text = null;
				txtContentWrite.Text = null;
			}
			else
		...
		private void decodeButton_Click(object sender, EventArgs e)
		{
			...
			if (dialogResult == DialogResult.Yes)
			{
				...
				else
				{
					...
					details.Text = ("The decrypted message has been saved in: " + saveFileDialog1.FileName);
					...
					{
						txtContentLoad.Text = null;
						txtContentLoad.Text = ("Encrypted content: " + "'" + Convert.ToString(File.ReadAllText(path)) + "'");
					}
				}
			}
			else if (dialogResult == DialogResult.No)
			{
				...
				{
					txtContentLoad.Text = null;
					txtContentLoad.Text = ("Encrypted content: " + "'" + System.Text.Encoding.UTF8.GetString(newFileTxt) + "'");
				}
			}
		}
		...
		{
			txtContentWrite.Text = "Encrypted message: " + Convert.ToString(File.ReadAllText(textPath2.Text));
			...
			saveFileDialog1.Title = "Select a location for the bitmap with the encrypted message:";
